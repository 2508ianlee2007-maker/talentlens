...
st.markdown("""
<style>
    /* ══ SIDEBAR — deep navy, works in both light and dark ══ */
    [data-testid="stSidebar"] {
        background: linear-gradient(160deg, #1e3a5f 0%, #0f2847 100%) !important;
        border-right: 1px solid rgba(255,255,255,0.08) !important;
    }
    /* Force ALL sidebar text to be bright white — no opacity tricks */
    [data-testid="stSidebar"],
    [data-testid="stSidebar"] *,
    ...
    [data-testid="stSidebar"] div { color: #e2e8f0 !important; opacity: 1 !important; }
    [data-testid="stSidebar"] h2,
    [data-testid="stSidebar"] h3 { color: #ffffff !important; }

    /* File uploader — force filenames and labels visible */
    ...
    [data-testid="stSidebar"] .stButton > button:hover {
        background: rgba(59,130,246,0.45) !important; color: #fff !important;
    }
    [data-testid="stSidebar"] .stDivider { opacity: 0.2 !important; }
    ...
    /* File item rows inside uploader */
    ...
    /* ══ TABS ══ */
    div[data-baseweb="tab-list"] { gap: 0.4rem; border-bottom: 2px solid rgba(59,130,246,0.3); }
    button[data-baseweb="tab"] { padding: 0.55rem 1.3rem; border-radius: 12px 12px 0 0 !important; font-weight: 500; }
    button[data-baseweb="tab"][aria-selected="true"] {
        border-bottom: 3px solid #3b82f6 !important; color: #3b82f6 !important; font-weight: 700 !important;
    }
    ...
    .v-strong  { background: rgba(29,78,216,0.18);  color: #60a5fa; border: 1px solid rgba(59,130,246,0.3); }
    .v-good    { background: rgba(22,163,74,0.18);   color: #4ade80; border: 1px solid rgba(22,163,74,0.3); }
    .v-partial { background: rgba(217,119,6,0.18);   color: #fbbf24; border: 1px solid rgba(217,119,6,0.3); }
    .v-weak    { background: rgba(220,38,38,0.18);   color: #f87171; border: 1px solid rgba(220,38,38,0.3); }

    /* ══ RECOMMENDATION BADGES ══ */
    .rec-advance { background:rgba(22,163,74,0.2);  color:#4ade80; border:1px solid rgba(22,163,74,0.4);  font-size:11px; padding:3px 12px; border-radius:20px; font-weight:700; display:inline-block; }
    .rec-hold    { background:rgba(217,119,6,0.2);  color:#fbbf24; border:1px solid rgba(217,119,6,0.4);  font-size:11px; padding:3px 12px; border-radius:20px; font-weight:700; display:inline-block; }
    .rec-reject  { background:rgba(220,38,38,0.2);  color:#f87171; border:1px solid rgba(220,38,38,0.4);  font-size:11px; padding:3px 12px; border-radius:20px; font-weight:700; display:inline-block; }

    /* ══ TAGS ══ */
    .tag { font-size:11px; padding:3px 11px; border-radius:20px; margin:2px; display:inline-block; font-weight:500; }
    .tag-s { background:rgba(59,130,246,0.15); color:#93c5fd; border:1px solid rgba(59,130,246,0.25); }
    .tag-g { background:rgba(220,38,38,0.15);  color:#fca5a5; border:1px solid rgba(220,38,38,0.25); }

    /* ══ SCORE ══ */
    .score-big   { font-size:2.8rem; font-weight:800; line-height:1; text-align:center; }
    .score-label { font-size:0.85rem; text-align:center; opacity:0.5; margin-top:2px; }
    ...
    .file-pill-size { font-size:11px; opacity:0.5; }
    ...
    /* ══ INFO BOXES ══ */
    .info-box    { background:rgba(59,130,246,0.1);  border-left:4px solid #3b82f6; border-radius:0 8px 8px 0; padding:10px 14px; font-size:13px; color:#93c5fd; margin-bottom:12px; }
    .warn-box    { background:rgba(217,119,6,0.1);   border-left:4px solid #d97706; border-radius:0 8px 8px 0; padding:10px 14px; font-size:13px; color:#fbbf24; margin-bottom:12px; }
    .success-box { background:rgba(22,163,74,0.1);   border-left:4px solid #16a34a; border-radius:0 8px 8px 0; padding:10px 14px; font-size:13px; color:#4ade80; margin-bottom:12px; }

    /* ══ METRICS ══ */
    [data-testid="stMetric"] {
        background:rgba(255,255,255,0.04) !important; border:1px solid rgba(148,163,184,0.12) !important;
    ...
    .reset-btn > button { background:rgba(220,38,38,0.15) !important; color:#f87171 !important; border:1px solid rgba(220,38,38,0.3) !important; }
    .reset-btn > button:hover { background:rgba(220,38,38,0.28) !important; }

    /* ══ MATRIX TABLE ══ */
    .matrix-table { width:100%; border-collapse:collapse; font-size:13px; }
    .matrix-table th { background:rgba(59,130,246,0.15); color:#93c5fd; padding:9px 16px; text-align:left; font-weight:600; border-bottom:2px solid rgba(59,130,246,0.25); }
    .matrix-table td { padding:8px 16px; border-bottom:1px solid rgba(255,255,255,0.05); vertical-align:middle; }
